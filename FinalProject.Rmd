...
Seems like there is certain hotspots in the south and in Texas and California with high number of cases. Rural areas seem to have lower number of cases, but some urbans areas have low and others have high. The American north west also seems to have a low number of cases
...
It seems like in rural areas people wear there mask less. The higher the low_usage score the less they wear their mask. Central United states seems to have lower mask usage when compared to the coasts. This may be due to central united states being more rural.
