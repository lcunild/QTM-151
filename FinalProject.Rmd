...
# MAKE PLOT OF US BY STATE/OR COUNTY COVID CASES BUT USE PLOTLY TO MAKE ANIMATION OVER TIME
plotyl_plot <-map_plot + scale_fill_gradientn(colours = rainbow(4), trans = "log10")+remove_axis

map_plot + scale_fill_gradientn(colours = rainbow(4), trans = "log10")+remove_axis

```
```{r}
ggplotly(plotyl_plot)
```
