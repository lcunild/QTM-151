---
title: "Covid Project Group 2"
author: "Lauren Cunild, Alan Yang, Dawit Dean, Wenqi Li, Zach Karol, Bowen You"
date: "12/1/2021"
...
As the data set is very large, we have chosen three dates, approximately 6 months apart. We chose all three dates to be a Wednesday, as reporting can be delayed over the weekend, which would skew our data if some dates were weekends, and some were not. Besides, We also parse the Strings in "date" column into date form using lubridate.
